...
- np. [glassdoor.com](http://glassdoor.com) czy portale społecznościowe
...
```{r echo = TRUE}
# Przejście do strony, powrót na poprzednią, odświeżenie, pozyskanie adresu
remDr$navigate(url)
remDr$goBack()
remDr$goForward()
remDr$refresh()
